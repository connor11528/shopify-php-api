...
use Shopify\Context;
use Shopify\Rest\Admin2021_07\GiftCardAdjustment;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class GiftCardAdjustment202107Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2021-07/gift_cards/1035197676/adjustments.json",
                "GET",
                null,
                [
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-07/gift_cards/1035197676/adjustments/9.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",

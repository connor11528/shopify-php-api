...
use Shopify\Context;
use Shopify\Rest\AdminUnstable\SmartCollection;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class SmartCollectionUnstableTest extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections.json?since_id=482865238",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections.json?product_id=632910392",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections.json?ids=482865238%2C1063001375",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_5(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["title" => "IPods", "rules" => [["column" => "title", "relation" => "starts_with", "condition" => "iPod"]]]]),
            ),
        ]);
    ...
    public function test_6(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["title" => "Macbooks", "rules" => [["column" => "vendor", "relation" => "equals", "condition" => "Apple"]]]]),
            ),
        ]);
    ...
    public function test_7(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["title" => "Macbooks", "rules" => [["column" => "vendor", "relation" => "equals", "condition" => "Apple"]], "published" => false]]),
            ),
        ]);
    ...
    public function test_8(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["title" => "Macbooks", "rules" => [["column" => "vendor", "relation" => "equals", "condition" => "Apple"]], "image" => ["attachment" => "R0lGODlhAQABAIAAAAAAAAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==\n", "alt" => "iPod"]]]),
            ),
        ]);
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["title" => "Macbooks", "rules" => [["column" => "vendor", "relation" => "equals", "condition" => "Apple"]], "image" => ["src" => "http://example.com/rails_logo.gif", "alt" => "Rails Logo"]]]),
            ),
        ]);
    ...
    public function test_10(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_11(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections/count.json?product_id=632910392",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_12(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_13(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["id" => 482865238, "body_html" => "<p>5000 songs in your pocket</p>"]]),
            ),
        ]);
    ...
    public function test_14(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["id" => 482865238, "published" => true]]),
            ),
        ]);
    ...
    public function test_15(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["id" => 482865238, "published" => false]]),
            ),
        ]);
    ...
    public function test_17(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["smart_collection" => ["id" => 482865238, "image" => ["alt" => "Rails logo"]]]),
            ),
        ]);
    ...
    public function test_20(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392",
                "PUT",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_21(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/smart_collections/482865238/order.json?sort_order=alpha-desc",
                "PUT",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",

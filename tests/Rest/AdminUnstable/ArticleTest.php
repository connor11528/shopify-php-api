...
use Shopify\Context;
use Shopify\Rest\AdminUnstable\Article;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class ArticleUnstableTest extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles.json?since_id=134645308",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["title" => "My new Article title", "author" => "John Smith", "tags" => "This Post, Has Been Tagged", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "published_at" => "Thu Mar 24 15:45:47 UTC 2011"]]),
            ),
        ]);

        $article = new Article($this->test_session);
    ...
    public function test_8(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles/count.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles/134645308.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_10(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "title" => "My new Title", "author" => "Your name", "tags" => "Tags, Will Be, Updated", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "Thu Mar 24 15:45:47 UTC 2011"]]),
            ),
        ]);
    ...
    public function test_11(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "published" => true]]),
            ),
        ]);
    ...
    public function test_12(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "published" => false]]),
            ),
        ]);
    ...
    public function test_14(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "title" => "My new Title", "author" => "Your name", "tags" => "Tags, Will Be, Updated", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "Thu Mar 24 15:45:47 UTC 2011", "image" => ["alt" => "Rails logo"]]]),
            ),
        ]);
    ...
    public function test_15(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "image" => ""]]),
            ),
        ]);
    ...
    public function test_16(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["article" => ["id" => 134645308, "metafields" => [["key" => "new", "value" => "newvalue", "type" => "single_line_text_field", "namespace" => "global"]]]]),
            ),
        ]);
    ...
    public function test_18(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/articles/authors.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_19(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles/tags.json?limit=1&popular=1",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_20(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/articles/tags.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_21(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/blogs/241253187/articles/tags.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_22(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/unstable/articles/tags.json?limit=1&popular=1",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",

...
use Shopify\Context;
use Shopify\Rest\Admin2021_04\CustomCollection;
use ShopifyTest\BaseTestCase;
use ShopifyTest\Clients\MockRequest;

final class CustomCollection202104Test extends BaseTestCase
{
    /** @var Session */
    ...
    public function test_1(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections.json",
                "GET",
                null,
                [
    ...
    public function test_2(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections.json?since_id=841564295",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_3(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections.json?product_id=632910392",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_4(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections.json?ids=395646240%2C691652237%2C841564295",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_9(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["title" => "Macbooks", "metafields" => [["key" => "new", "value" => "newvalue", "value_type" => "string", "namespace" => "global"]]]]),
            ),
        ]);
    ...
    public function test_10(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections/count.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_11(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections/count.json?product_id=632910392",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_12(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                $this->buildMockHttpResponse(200, ""),
                "https://test-shop.myshopify.io/admin/api/2021-04/custom_collections/841564295.json",
                "GET",
                null,
                [
                    "X-Shopify-Access-Token: this_is_a_test_token",
    ...
    public function test_13(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "body_html" => "<p>5000 songs in your pocket</p>"]]),
            ),
        ]);
    ...
    public function test_14(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "collects" => [["product_id" => 921728736, "position" => 1], ["id" => 455204334, "position" => 2]]]]),
            ),
        ]);
    ...
    public function test_15(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "published" => true]]),
            ),
        ]);
    ...
    public function test_16(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "published" => false]]),
            ),
        ]);
    ...
    public function test_18(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "image" => ["alt" => "Rails logo"]]]),
            ),
        ]);
    ...
    public function test_19(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "image" => "", "updated_at" => "2022-02-03T17:12:38-05:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => null, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"]]),
            ),
        ]);
    ...
    public function test_20(): void
    {
        $this->mockTransportRequests([
            new MockRequest(
                ...
                json_encode(["custom_collection" => ["id" => 841564295, "metafields" => [["key" => "new", "value" => "newvalue", "value_type" => "string", "namespace" => "global"]]]]),
            ),
        ]);
